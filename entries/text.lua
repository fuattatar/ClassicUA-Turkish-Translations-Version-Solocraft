...
— Додано переклад 1246 завдань:
    ...
    - класи: друїд, жрець, маг, мисливець, паладин, розбійник, чорнокнижник, шаман
...
Версія 2.2 / 13.06.20
— Додано переклад 23 завдань (Підмістя, прірва Лютого Полум'я), 40 персонажів, 28 предмедів та 92 локацій
...
— Додано стилізовані шрифи з літерами "ї", "ґ", "є"; шрифт заголовка завдання тепер відрізняється від основного тексту завдання
...
Версія 1.4 / 26.01.20
— Додано переклад 1 закляття та 6 персонажів, виправлено переклад 1 квеста Орди
...
— Реалізовано підтримку шаблонів пошуку для спелів та предметів (для коректної локалізації тексту з динамічними числовими значеннями)
...
Версія 0.9 / 29.09.19
— Додано переклад 33 завдань Альянса (Тельдрассіль), 90+ заклять (70+ оновлено), 30 предметів та 2 персонажів
...
— Виправлено помилку з прокручуванням тексту в фреймі квеста
...
— Збільшено розмір шрифта тексту завдання
